...
f16sentence1 <- 
  ...
  if (repChange1 == loyChange1 & repChange1 == "no significant change") {
    ...
    paste0("Since ", NILTyear - 1, " there has been ", loyChange1, " in the proportion of adults who felt annoyed by loyalist murals (",
           loyDiff1, " percentage points) and there was also ", repChange1, " in the proportion of adults who felt annoyed by republican murals (",
           repDiff1, " percentage points).")
    ...
    paste0("Since ", NILTyear - 1, " there has been ", loyChange1, " in the proportion of adults who felt annoyed by loyalist murals (",
           loyDiff1, " percentage points) however there was no significant change in the proportion of adults who felt annoyed by republican murals.")
    # Republican not significant and loyalist significant
  } else if (repChange1 != "no significant change" & loyChange1 == "no significant change") {
    paste0("Since ", NILTyear - 1, " there has been ", repChange1, " in the proportion of adults who felt annoyed by republican murals (",
           repDiff1, " percentage points) however there was no significant change in the proportion of adults who felt annoyed by loyalist murals.")
    ...
    paste0("Since ", NILTyear - 1, " there has been ", loyChange1, " in the proportion of adults who felt annoyed by loyalist murals (",
           loyDiff1, " percentage points) however there was ", repChange1, " in the proportion of adults who felt annoyed by republican murals (",
           repDiff1, " percentage points).")
  }
...
f16sentence2 <-
  if (repChange2 == loyChange2 & repChange2 == "no significant change") {
    ...
    paste0("There has been ", loyChange2, " in the proportion of adults who felt intimidated by loyalist murals (",
           loyDiff2, " percentage points) and there was also ", repChange2, " in the proportion of adults who felt intimidated by republican murals (",
           repDiff2, " percentage points).")
    # Republican not significant and loyalist significant
  } else if (repChange2 == "no significant change" & loyChange2 != "no significant change") {
    paste0("There has been ", loyChange2, " in the proportion of adults who felt intimidated by loyalist murals (",
           loyDiff2, " percentage points) however there was no significant change in the proportion of adults who felt intimidated by republican murals.")
    # Republican not significant and loyalist significant
  } else if (repChange2 != "no significant change" & loyChange2 == "no significant change") {
    paste0("There has been ", repChange2, " in the proportion of adults who felt intimidated by republican murals (",
           repDiff2, " percentage points) however there was no significant change in the proportion of adults who felt intimidated by loyalist murals.")
    # Both significant but different
  } else if (repChange2 != "no significant change" & loyChange2 != "no significant change" & repChange != loyChange2) {
    paste0("There has been ", loyChange2, " in the proportion of adults who felt intimidated by loyalist murals (",
           loyDiff2, " percentage points) however there was ", repChange2, " in the proportion of adults who felt intimidated by republican murals (",
           repDiff2, " percentage points).")
  }
