...
f22para1 <- if (cathSig == FALSE & protSig == FALSE & meSig != FALSE) {
  ...
  paste0("There was no significant change in proportion of respondents who think the culture and traditions of Catholic and Protestant communities add to the richness and diversity of Northern Ireland society since ",
         ...
         round2(abs(dataNew$f22_me - dataOld$f22_me)), " percentage points).")
  ...
  paste0("The proportion of respondents who think the culture and traditions of Catholic and Protestant communities add to the richness and diversity of Northern Ireland society has ",
         ...
         " (by ", round2(abs(dataNew$f22_cath - dataOld$f22_cath))," percentage points and ",
         round2(abs(dataNew$f22_prot - dataOld$f22_prot)),
         " percentage points respectively). There has been no significant change in the proportion who think this in relation to Minority Ethnic communities.")
  ...
  paste0("The proportion of respondents who think the culture and traditions of Catholic and Protestant communities add to the richness and diversity of Northern Ireland society has ",
         ...
         " (by ", round2(abs(dataNew$f22_cath - dataOld$f22_cath))," percentage points and ",
         round2(abs(dataNew$f22_prot - dataOld$f22_prot)),
         " percentage points respectively). The proportion who think this in relation to Minority Ethnic communities has ",
  ...
  paste0("The proportion of respondents who think the culture and traditions of Catholic communites add to the richness and diversity of Northern Ireland society has ",
         ...
         " percentage points while the proportion who think this about Protestant communities has ",
  ...
  paste0("The proportion of respondents who think the culture and traditions of Catholic communites add to the richness and diversity of Northern Ireland society has ",
         ...
         sub("t", "tly", protSig), "d by ", round2(abs(dataNew$f22_prot - dataOld$f22_prot)),
         " percentage points since ", NILTyear - 1,
         ". The proportion who think this in relation to Minority Ethnic communities has ",
         sub("t", "tly", meSig),"d by ", round2(abs(dataNew$f22_me - dataOld$f22_me)),
         " percentage points.")
  ...
  paste0("The proportion of respondents who think the culture and traditions of Catholic communites add to the richness and diversity of Northern Ireland society has ",
         sub("t", "tly", cathSig),"d by ", round2(abs(dataNew$f22_cath - dataOld$f22_cath)),
         " percentage points since ", NILTyear - 1,
         " but there has been no significant change in the proportion who think this about Protestant communities. There has also been no significant change in the proportion who think this in relation to Minority Ethnic communities.")
  ...
  paste0("The proportion of respondents who think the culture and traditions of Catholic communites add to the richness and diversity of Northern Ireland society has ",
         sub("t", "tly", cathSig),"d by ", round2(abs(dataNew$f22_cath - dataOld$f22_cath)),
         " percentage points since ", NILTyear - 1,
         " but there has been no significant change in the proportion who think this about Protestant communities. The proportion who think this in relation to Minority Ethnic communities has ",
         sub("t", "tly", meSig),"d by ", round2(abs(dataNew$f22_me - dataOld$f22_me)),
         " percentage points.")
  ...
  paste0("The proportion of respondents who think the culture and traditions of Protestant communites add to the richness and diversity of Northern Ireland society has ",
         sub("t", "tly", protSig),"d by ", round2(abs(dataNew$f22_prot - dataOld$f22_prot)),
         " percentage points since ", NILTyear - 1,
         " but there has been no significant change in the proportion who think this about Catholic communities. There has also been no significant change in the proportion who think this in relation to Minority Ethnic communities.")
  ...
  paste0("The proportion of respondents who think the culture and traditions of Protestant communites add to the richness and diversity of Northern Ireland society has ",
         sub("t", "tly", protSig),"d by ", round2(abs(dataNew$f22_prot - dataOld$f22_prot)),
         " percentage points since ", NILTyear - 1,
         " but there has been no significant change in the proportion who think this about Catholic communities. The proportion who think this in relation to Minority Ethnic communities has ",
         sub("t", "tly", meSig),"d by ", round2(abs(dataNew$f22_me - dataOld$f22_me)),
         " percentage points.")
