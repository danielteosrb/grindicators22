...
} else if (youngNISiglast != FALSE & youngNeighSiglast == FALSE & adultNISiglast == youngNISiglast & adultNeighSiglast == youngNISiglast){
  paste0("Since ", NILTyear -1, ", the proportion of adults who feel a sense of belonging to both their neighbourhood (", NILTyear, ": ", belongNeigh, "%; ", NILTyear - 1, ": ", round2(dataOld$f20_adultNeigh), "%) and Northern Ireland (", NILTyear, ": ", belongNI, "%; ", NILTyear - 1, ": ", round2(dataOld$f20_adultNI), "%) has ", if (adultNISiglast == "significant increase") {"increased"} else {"decreased"}, " significantly. The proportion of young people who feel a sense of belonging to Northern Ireland has also ", if (adultNISiglast == "significant increase") {"increased"} else {"decreased"}, " significantly (", YLTyear, ": ", youngNI, "%; ", NILTyear - 1, ": ", round2(dataOld$f20_youngNI), "%), however, the proportion of young people who feel a sense of belonging to their neighbourhood has not undergone any significant change.")
}
