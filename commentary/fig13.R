...
f13para2 <- paste0("Since 2013/14, there has been a significant increase in the percentage of first preference applications to post-primary integrated schools that do not result in admissions to that particular school – an increase of ",
                   round2(abs(fig13$pct[fig13 == intYear] - fig13$pct[fig13$year == "2013/14"]))," percentage points (", intYear, ": ", round2(fig13$pct[fig13$year == intYear]), "%; 2013: ", round2(fig13$pct[fig13$year == "2013/14"]), "%). This represents an increasing over-subscription to popular post-primary integrated schools.")