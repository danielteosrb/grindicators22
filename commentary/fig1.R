...
protSig <-
  ...
  if(adultProtSig != FALSE & adultProtSig == youngProtSig) {
    ...
    paste0("From ", LTyear - 1, " to ", LTyear, " there was a ", adultProtSig, " of ", abs(dataNew$f1a_Prot - dataOld$f1a_Prot), " percentage points in the proportion of adults identifying as Protestant, who think relations between Protestants and Catholics are better now than they were five years ago (", NILTyear, ": ", dataNew$f1a_Prot, "%; ", NILTyear - 1, ": ", dataOld$f1a_Prot, "%), however there was ", youngProtSig, " of ", abs(dataNew$f1y_Prot - dataOld$f1y_Prot), " percentage points in this measure among young people who identify as Protestant (", YLTyear, ": ", dataNew$f1y_Prot, "%; ", YLTyear - 1, ": ", dataOld$f1y_Prot, "%).")
  }
...
cathSig <-
  ...
  if(adultCathSig != FALSE & adultCathSig == youngCathSig) {
    ...
    paste0("Adult respondents identifying as Catholic who think relations between Protestants and Catholics are better now than they were five years ago has ", sub("significant", "significantly", adultCathSig), "d (", abs(dataNew$f1a_Cath - dataOld$f1a_Cath)," percentage points) (", NILTyear, ": ", dataNew$f1a_Cath, "%; ", NILTyear - 1, ": ", dataOld$f1a_Cath, "%). However, among young people who identify as Catholic there was a ", youngCathSig, " of ", abs(dataNew$f1y_Cath - dataOld$f1y_Cath)," percentage points (", YLTyear, ": ", dataNew$f1y_Cath, "%; ", YLTyear - 1, ": ", dataOld$f1y_Cath, "%).")
  }

f1para1 <- paste0("Since ", LTyear - 1, ", there has been ", if (adultSig==FALSE){"no significant change"} else{paste("a",adultSig)},
