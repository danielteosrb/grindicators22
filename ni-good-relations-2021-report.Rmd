...
YLTyear <- 2021
# Solving for year of missing YLT data in 2021 report
lastYLTyear <- if(YLTyear == 2021) {
  YLTyear - 2
} else {
  YLTyear - 1
}
...
# Read in spss data
NILT <- read.spss("data/NILT 2021.sav", to.data.frame = TRUE)
YLT <- read.spss("data/YLT 2020-21.sav", to.data.frame = TRUE)
...
niltNew <- data.frame(year = NILTyear,
                      ...
                      f12_neighbourhood = colPct(NILT, MXRLGNGH, "Mixed religion neighbourhood"),
                      f12_workplace = colPct(NILT, MXRLGWRK, "Mixed religion workplace"),
                      f12_school = colPct(NILT, OWNMXSCH, "Mixed religion school"),
...
yltNew <- data.frame(year = YLTyear,
                     ...
                     RLRELAGO_YnCath = unweighted_n(YLT$RLRELAGO[YLT$RELIGCAT == toupper("Catholic")]),
                     RLRELAGO_YnProt = unweighted_n(YLT$RLRELAGO[YLT$RELIGCAT == toupper("Protestant")]),
                     RLRELAGO_YnNoR = unweighted_n(YLT$RLRELAGO[YLT$RELIGCAT == toupper("No religion")]),
                     ...
                     SOCDIFF_YnCath = unweighted_n(YLT$SOCDIFF[YLT$RELIGCAT == toupper("Catholic")]),
                     SOCDIFF_YnProt = unweighted_n(YLT$SOCDIFF[YLT$RELIGCAT == toupper("Protestant")]),
