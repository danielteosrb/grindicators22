...
# Read in spss data
NILT21 <- read.spss("data/NILT 2021.sav", to.data.frame = TRUE)
YLT21 <- read.spss("data/YLT 2020-21.sav", to.data.frame = TRUE)
...
niltOld <- data.frame(year = NILTyear - 1,
                      f1_adults = colPct(NILT21, RLRELAGO, "Better"),
                      f1a_Cath = colPct(NILT21, RLRELAGO, "Better", religion = "Catholic"),
                      f1a_Prot = colPct(NILT21, RLRELAGO, "Better", religion = "Protestant"),
                      f1a_NoR = colPct(NILT21, RLRELAGO, "Better", religion = "No religion"),
                      f2_adults = colPct(NILT21, RLRELFUT, "Better"),
                      f2a_Cath = colPct(NILT21, RLRELFUT, "Better", religion = "Catholic"),
                      f2a_Prot = colPct(NILT21, RLRELFUT, "Better", religion = "Protestant"),
                      f2a_NoR = colPct(NILT21, RLRELFUT, "Better", religion = "No religion"),
                      f3a_adults = colPct(NILT21, FEELCATH, c("Very favourable", "Favourable")),
                      f3b_adults = colPct(NILT21, FEELPROT, c("Very favourable", "Favourable")),
                      f3c_adults = colPct(NILT21, FEELMEG, c("Very favourable", "Favourable")),
                      f6b_yes = colPct(NILT21, COMDIV, c("A lot", "A little")),
                      f6b_no = colPct(NILT21, COMDIV, c("Not at all")),
                      f6_lot = colPct(NILT21, COMDIV, "A lot"),
                      f6_little = colPct(NILT21, COMDIV, "A little"),
                      f6_dunno = colPct(NILT21, COMDIV, "Don't know"),
                      f7_LC = colPct(NILT21, LCOPEN, c("Yes, definitely", "Yes, probably")),
                      f7_park = colPct(NILT21, PARKOPEN, c("Yes, definitely", "Yes, probably")),
                      f7_lib = colPct(NILT21, LIBOPEN, c("Yes, definitely", "Yes, probably")),
                      f7_SHCN = colPct(NILT21, SHCNOPEN, c("Yes, definitely", "Yes, probably")),
                      f8_pct = colPct(NILT21, SCHLCULT2, c("Yes, definitely", "Yes, probably")),
                      f8_Prot = colPct(NILT21, SCHLCULT2, c("Yes, definitely", "Yes, probably"), religion = "Catholic"),
                      f8_Cath = colPct(NILT21, SCHLCULT2, c("Yes, definitely", "Yes, probably"), religion = "Protestant"),
                      f8_NoR = colPct(NILT21, SCHLCULT2, c("Yes, definitely", "Yes, probably"), religion = "No religion"),
                      f11_workplace = colPct(NILT21, WORKCULT2, c("Yes, definitely", "Yes, probably")),
                      f11_neighbourhood = colPct(NILT21, NGHCULT2, c("Yes, definitely", "Yes, probably")),
                      f12_neighbourhood = colPct(NILT21, MXRLGNGH, "A mixed religion neighbourhood"),
                      f12_workplace = colPct(NILT21, MXRLGWRK, "A mixed religion workplace"),
                      f12_school = colPct(NILT21, OWNMXSCH, "A mixed religion school"),
                      f16_aR = colPct(NILT21, REPMUR2, "Yes"),
                      f16_iR = colPct(NILT21, REPMURAL, "Yes"),
                      f16_aL = colPct(NILT21, LOYMUR2, "Yes"),
                      f16_iL = colPct(NILT21, LOYMURAL, "Yes"),
                      f17_compare = colPct(NILT21, NISAFEWL, c("Strongly agree", "Agree")),
                      f18_prot = colPct(NILT21, GOPSCHL, c("Very safe", "Quite safe")),
                      f18_cath = colPct(NILT21, GOCSCHL, c("Very safe", "Quite safe")),
                      f18_gaa = colPct(NILT21, GOGAA, c("Very safe", "Quite safe")),
                      f18_orange = colPct(NILT21, GOOH, c("Very safe", "Quite safe")),
                      f19_resident = colPct(NILT21, PLINEREM, c("I would like the Peace Lines to come down now", "I would like the Peace Lines to come down in the future"), resident = TRUE),
                      f20_adultNeigh = colPct(NILT21, UBELNGH, c("Yes, definitely", "Yes, probably")),
                      f20_adultNI = colPct(NILT21, UBELNI, c("Yes, definitely", "Yes, probably")),
                      f21b_neighbourhood = colPct(NILT21, INFLLOCL, c("Yes, probably", "Yes, definitely")),
                      f21b_NI = colPct(NILT21, INFLNI, c("Yes, probably", "Yes, definitely")),
                      f22_cath = colPct(NILT21, CTHCRICH, c("Strongly agree", "Agree")),
                      f22_prot = colPct(NILT21, PRCRICH, c("Strongly agree", "Agree")),
                      f22_me = colPct(NILT21, EMCRICH, c("Strongly agree", "Agree")),
                      f23_compare = colPct(NILT21, CULTRESP, c("Strongly agree", "Agree")),
                      RLRELAGO_n = unweighted_n(NILT21$RLRELAGO),
                      RLRELFUT_n = unweighted_n(NILT21$RLRELFUT),
                      RLRELFUT_nCath = unweighted_n(NILT21$RLRELFUT[NILT21$RELIGCAT == "Catholic"]),
                      RLRELFUT_nProt = unweighted_n(NILT21$RLRELFUT[NILT21$RELIGCAT == "Protestant"]),
                      RLRELFUT_nNoR = unweighted_n(NILT21$RLRELFUT[NILT21$RELIGCAT == "No religion"]),
                      RLRELAGO_nCath = unweighted_n(NILT21$RLRELAGO[NILT21$RELIGCAT == "Catholic"]),
                      RLRELAGO_nProt = unweighted_n(NILT21$RLRELAGO[NILT21$RELIGCAT == "Protestant"]),
                      RLRELAGO_nNoR = unweighted_n(NILT21$RLRELAGO[NILT21$RELIGCAT == "No religion"]),
                      SCHLCULT2_n = unweighted_n(NILT21$SCHLCULT2),
                      SCHLCULT2_nCath = unweighted_n(NILT21$SCHLCULT2[NILT21$RELIGCAT == "Catholic"]),
                      SCHLCULT2_nProt = unweighted_n(NILT21$SCHLCULT2[NILT21$RELIGCAT == "Protestant"]),
                      SCHLCULT2_nNoR = unweighted_n(NILT21$SCHLCULT2[NILT21$RELIGCAT == "No religion"]),
                      NISAFEWL_n = unweighted_n(NILT21$NISAFEWL),
                      INFLLOCL_n = unweighted_n(NILT21$INFLLOCL),
                      INFLNI_n = unweighted_n(NILT21$INFLNI),
                      LOYMURAL_n = unweighted_n(NILT21$LOYMURAL),
                      REPMURAL_n = unweighted_n(NILT21$REPMURAL),
                      LOYMUR2_n = unweighted_n(NILT21$LOYMUR2),
                      REPMUR2_n = unweighted_n(NILT21$REPMUR2),
                      COMDIV_n = unweighted_n(NILT21$COMDIV),
                      LCOPEN_n = unweighted_n(NILT21$LCOPEN),
                      PARKOPEN_n = unweighted_n(NILT21$PARKOPEN),
                      LIBOPEN_n = unweighted_n(NILT21$LIBOPEN),
                      SHCNOPEN_n = unweighted_n(NILT21$SHCNOPEN),
                      WORKCULT2_n = unweighted_n(NILT21$WORKCULT2),
                      NGHCULT2_n = unweighted_n(NILT21$NGHCULT2),
                      CULTRESP_n = unweighted_n(NILT21$CULTRESP),
                      MXRLGNGH_n = unweighted_n(NILT21$MXRLGNGH),
                      MXRLGWRK_n = unweighted_n(NILT21$MXRLGWRK),
                      OWNMXSCH_n = unweighted_n(NILT21$OWNMXSCH),
                      GOPSCHL_n = unweighted_n(NILT21$GOPSCHL),
                      GOCSCHL_n = unweighted_n(NILT21$GOCSCHL),
                      GOGAA_n = unweighted_n(NILT21$GOGAA),
                      GOOH_n = unweighted_n(NILT21$GOOH),
                      UBELNGH_n = unweighted_n(NILT21$UBELNGH),
                      UBELNI_n = unweighted_n(NILT21$UBELNI),
                      PRCRICH_n = unweighted_n(NILT21$PRCRICH),
                      CTHCRICH_n = unweighted_n(NILT21$CTHCRICH),
                      EMCRICH_n = unweighted_n(NILT21$EMCRICH),
                      PLINEREM_Rn = unweighted_n(NILT21$PLINEREM[NILT21$PLINELIV == "Within a few streets of the nearest Peace Line"]))

yltOld <- data.frame(year = YLTyear - 1,
                     f1_young =  colPct(YLT21, RLRELAGO, "Better"),
                     f1y_Cath = colPct(YLT21, RLRELAGO, "Better", religion = "Catholic"),
                     f1y_Prot = colPct(YLT21, RLRELAGO, "Better", religion = "Protestant"),
                     f1y_NoR = colPct(YLT21, RLRELAGO, "Better", religion = "No religion"),
                     f2_young =  colPct(YLT21, RLRELFUT, "Better"),
                     f3a_young = colPct(YLT21, FEELCATH, c("Very favourable", "Quite favourable")),
                     f3b_young = colPct(YLT21, FEELPROT, c("Very favourable", "Quite favourable")),
                     f3c_young = colPct(YLT21, FEELMEC, c("Very favourable", "Quite favourable")),
                     f4a_male = colPct(YLT21, SOCDIFF, c("Very often", "Sometimes"), gender = "Male"),
                     f4a_female = colPct(YLT21, SOCDIFF, c("Very often", "Sometimes"), gender = "Female"),
                     f4a_overall = colPct(YLT21, SOCDIFF, c("Very often", "Sometimes")),
                     f4_Cath = colPct(YLT21, SOCDIFF, c("Very often", "Sometimes"), religion = "Catholic"),
                     f4_Prot = colPct(YLT21, SOCDIFF, c("Very often", "Sometimes"), religion = "Protestant"),
                     f4_NoR = colPct(YLT21, SOCDIFF, c("Very often", "Sometimes"), religion = "No religion"),
                     f20_youngNeigh = colPct(YLT21, BELONGNG, c("Yes, definitely", "Yes, probably")),
                     f20_youngNI = colPct(YLT21, BELONGNI, c("Yes, definitely", "Yes, probably")),
                     f21a_neighbourhood = colPct(YLT21, INFLHERE, c("Yes, probably", "Yes, definitely")),
                     f21a_NI = colPct(YLT21, INFLUNI, c("Yes, probably", "Yes, definitely")),
                     RLRELAGO_YnCath = unweighted_n(YLT21$RLRELAGO[YLT21$RELIGCAT == toupper("Catholic")]),
                     RLRELAGO_YnProt = unweighted_n(YLT21$RLRELAGO[YLT21$RELIGCAT == toupper("Protestant")]),
                     RLRELAGO_YnNoR = unweighted_n(YLT21$RLRELAGO[YLT21$RELIGCAT == toupper("No religion")]),
                     RLRELAGO_Yn = unweighted_n(YLT21$RLRELAGO),
                     RLRELFUT_Yn = unweighted_n(YLT21$RLRELFUT),
                     FEELCATH_Yn = unweighted_n(YLT21$FEELCATH),
                     FEELPROT_Yn = unweighted_n(YLT21$FEELPROT),
                     FEELMEC_Yn = unweighted_n(YLT21$FEELMEC),
                     SOCDIFF_Yn = unweighted_n(YLT21$SOCDIFF),
                     SOCDIFF_YnCath = unweighted_n(YLT21$SOCDIFF[YLT21$RELIGCAT == toupper("Catholic")]),
                     SOCDIFF_YnProt = unweighted_n(YLT21$SOCDIFF[YLT21$RELIGCAT == toupper("Protestant")]),
                     SOCDIFF_YnMale = unweighted_n(YLT21$SOCDIFF[YLT21$RSEX == "Male"]),
                     SOCDIFF_YnFemale = unweighted_n(YLT21$SOCDIFF[YLT21$RSEX == "Female"]),
                     BELONGNG_Yn = unweighted_n(YLT21$BELONGNG),
                     BELONGNI_Yn = unweighted_n(YLT21$BELONGNI),
                     INFLHERE_Yn = unweighted_n(YLT21$INFLHERE),
                     INFLUNI_Yn = unweighted_n(YLT21$INFLUNI))
