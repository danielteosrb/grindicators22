...
niltOld <- data.frame(year = NILTyear - 1,
                      ...
                      f12_neighbourhood = colPct(NILTlast, MXRLGNGH, "A mixed religion neighbourhood"),
                      f12_workplace = colPct(NILTlast, MXRLGWRK, "A mixed religion workplace"),
                      f12_school = colPct(NILTlast, OWNMXSCH, "A mixed religion school"),
