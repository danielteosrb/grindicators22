---
title: "Northern Ireland Good Relations Indicators 2022 Report"
lang: "en"
output: 
  html_document:
    fig_caption: false
...
pubDate <- "14th March 2024"
# Name of report contact
contact <- "Daniel Nelson-Donaghy"

# Read in spss data
NILTlast <- read.spss("data/NILT 2021.sav", to.data.frame = TRUE)
YLTlast <- read.spss("data/YLT 2020-21.sav", to.data.frame = TRUE)
NILT <- read.spss("data/NILT 2022.sav", to.data.frame = TRUE)
YLT <- read.spss("data/YLT 2022.sav", to.data.frame = TRUE)
NILT14 <- read.spss("data/NILT 2014.sav", to.data.frame = TRUE)
...
niltOld <- data.frame(year = NILTyear - 1,
                      f1_adults = colPct(NILTlast, RLRELAGO, "Better"),
                      f1a_Cath = colPct(NILTlast, RLRELAGO, "Better", religion = "Catholic"),
                      f1a_Prot = colPct(NILTlast, RLRELAGO, "Better", religion = "Protestant"),
                      f1a_NoR = colPct(NILTlast, RLRELAGO, "Better", religion = "No religion"),
                      f2_adults = colPct(NILTlast, RLRELFUT, "Better"),
                      f2a_Cath = colPct(NILTlast, RLRELFUT, "Better", religion = "Catholic"),
                      f2a_Prot = colPct(NILTlast, RLRELFUT, "Better", religion = "Protestant"),
                      f2a_NoR = colPct(NILTlast, RLRELFUT, "Better", religion = "No religion"),
                      f3a_adults = colPct(NILTlast, FEELCATH, c("Very favourable", "Favourable")),
                      f3b_adults = colPct(NILTlast, FEELPROT, c("Very favourable", "Favourable")),
                      f3c_adults = colPct(NILTlast, FEELMEG, c("Very favourable", "Favourable")),
                      f6b_yes = colPct(NILTlast, COMDIV, c("A lot", "A little")),
                      f6b_no = colPct(NILTlast, COMDIV, c("Not at all")),
                      f6_lot = colPct(NILTlast, COMDIV, "A lot"),
                      f6_little = colPct(NILTlast, COMDIV, "A little"),
                      f6_dunno = colPct(NILTlast, COMDIV, "Don't know"),
                      f7_LC = colPct(NILTlast, LCOPEN, c("Yes, definitely", "Yes, probably")),
                      f7_park = colPct(NILTlast, PARKOPEN, c("Yes, definitely", "Yes, probably")),
                      f7_lib = colPct(NILTlast, LIBOPEN, c("Yes, definitely", "Yes, probably")),
                      f7_SHCN = colPct(NILTlast, SHCNOPEN, c("Yes, definitely", "Yes, probably")),
                      f8_pct = colPct(NILTlast, SCHLCULT2, c("Yes, definitely", "Yes, probably")),
                      f8_Prot = colPct(NILTlast, SCHLCULT2, c("Yes, definitely", "Yes, probably"), religion = "Catholic"),
                      f8_Cath = colPct(NILTlast, SCHLCULT2, c("Yes, definitely", "Yes, probably"), religion = "Protestant"),
                      f8_NoR = colPct(NILTlast, SCHLCULT2, c("Yes, definitely", "Yes, probably"), religion = "No religion"),
                      f11_workplace = colPct(NILTlast, WORKCULT2, c("Yes, definitely", "Yes, probably")),
                      f11_neighbourhood = colPct(NILTlast, NGHCULT2, c("Yes, definitely", "Yes, probably")),
                      f12_neighbourhood = colPct(NILTlast, MXRLGNGH, "Mixed religion neighbourhood"),
                      f12_workplace = colPct(NILTlast, MXRLGWRK, "Mixed religion workplace"),
                      f12_school = colPct(NILTlast, OWNMXSCH, "Mixed religion school"),
                      f16_aR = colPct(NILTlast, REPMUR2, "Yes"),
                      f16_iR = colPct(NILTlast, REPMURAL, "Yes"),
                      f16_aL = colPct(NILTlast, LOYMUR2, "Yes"),
                      f16_iL = colPct(NILTlast, LOYMURAL, "Yes"),
                      f17_compare = colPct(NILTlast, NISAFEWL, c("Strongly agree", "Agree")),
                      f18_prot = colPct(NILTlast, GOPSCHL, c("Very safe", "Quite safe")),
                      f18_cath = colPct(NILTlast, GOCSCHL, c("Very safe", "Quite safe")),
                      f18_gaa = colPct(NILTlast, GOGAA, c("Very safe", "Quite safe")),
                      f18_orange = colPct(NILTlast, GOOH, c("Very safe", "Quite safe")),
                      f19_resident = colPct(NILTlast, PLINEREM, c("I would like the Peace Lines to come down now", "I would like the Peace Lines to come down in the future"), resident = TRUE),
                      f20_adultNeigh = colPct(NILTlast, UBELNGH, c("Yes, definitely", "Yes, probably")),
                      f20_adultNI = colPct(NILTlast, UBELNI, c("Yes, definitely", "Yes, probably")),
                      f21b_neighbourhood = colPct(NILTlast, INFLLOCL, c("Yes, probably", "Yes, definitely")),
                      f21b_NI = colPct(NILTlast, INFLNI, c("Yes, probably", "Yes, definitely")),
                      f22_cath = colPct(NILTlast, CTHCRICH, c("Strongly agree", "Agree")),
                      f22_prot = colPct(NILTlast, PRCRICH, c("Strongly agree", "Agree")),
                      f22_me = colPct(NILTlast, EMCRICH, c("Strongly agree", "Agree")),
                      f23_compare = colPct(NILTlast, CULTRESP, c("Strongly agree", "Agree")),
                      RLRELAGO_n = unweighted_n(NILTlast$RLRELAGO),
                      RLRELFUT_n = unweighted_n(NILTlast$RLRELFUT),
                      RLRELFUT_nCath = unweighted_n(NILTlast$RLRELFUT[NILTlast$RELIGCAT == "Catholic"]),
                      RLRELFUT_nProt = unweighted_n(NILTlast$RLRELFUT[NILTlast$RELIGCAT == "Protestant"]),
                      RLRELFUT_nNoR = unweighted_n(NILTlast$RLRELFUT[NILTlast$RELIGCAT == "No religion"]),
                      RLRELAGO_nCath = unweighted_n(NILTlast$RLRELAGO[NILTlast$RELIGCAT == "Catholic"]),
                      RLRELAGO_nProt = unweighted_n(NILTlast$RLRELAGO[NILTlast$RELIGCAT == "Protestant"]),
                      RLRELAGO_nNoR = unweighted_n(NILTlast$RLRELAGO[NILTlast$RELIGCAT == "No religion"]),
                      SCHLCULT2_n = unweighted_n(NILTlast$SCHLCULT2),
                      SCHLCULT2_nCath = unweighted_n(NILTlast$SCHLCULT2[NILTlast$RELIGCAT == "Catholic"]),
                      SCHLCULT2_nProt = unweighted_n(NILTlast$SCHLCULT2[NILTlast$RELIGCAT == "Protestant"]),
                      SCHLCULT2_nNoR = unweighted_n(NILTlast$SCHLCULT2[NILTlast$RELIGCAT == "No religion"]),
                      FEELCATH_n = unweighted_n(NILTlast$FEELCATH),
                      FEELPROT_n = unweighted_n(NILTlast$FEELPROT),
                      FEELMEC_n = unweighted_n(NILTlast$FEELMEG),
                      NISAFEWL_n = unweighted_n(NILTlast$NISAFEWL),
                      INFLLOCL_n = unweighted_n(NILTlast$INFLLOCL),
                      INFLNI_n = unweighted_n(NILTlast$INFLNI),
                      LOYMURAL_n = unweighted_n(NILTlast$LOYMURAL),
                      REPMURAL_n = unweighted_n(NILTlast$REPMURAL),
                      LOYMUR2_n = unweighted_n(NILTlast$LOYMUR2),
                      REPMUR2_n = unweighted_n(NILTlast$REPMUR2),
                      COMDIV_n = unweighted_n(NILTlast$COMDIV),
                      LCOPEN_n = unweighted_n(NILTlast$LCOPEN),
                      PARKOPEN_n = unweighted_n(NILTlast$PARKOPEN),
                      LIBOPEN_n = unweighted_n(NILTlast$LIBOPEN),
                      SHCNOPEN_n = unweighted_n(NILTlast$SHCNOPEN),
                      WORKCULT2_n = unweighted_n(NILTlast$WORKCULT2),
                      NGHCULT2_n = unweighted_n(NILTlast$NGHCULT2),
                      CULTRESP_n = unweighted_n(NILTlast$CULTRESP),
                      MXRLGNGH_n = unweighted_n(NILTlast$MXRLGNGH),
                      MXRLGWRK_n = unweighted_n(NILTlast$MXRLGWRK),
                      OWNMXSCH_n = unweighted_n(NILTlast$OWNMXSCH),
                      GOPSCHL_n = unweighted_n(NILTlast$GOPSCHL),
                      GOCSCHL_n = unweighted_n(NILTlast$GOCSCHL),
                      GOGAA_n = unweighted_n(NILTlast$GOGAA),
                      GOOH_n = unweighted_n(NILTlast$GOOH),
                      UBELNGH_n = unweighted_n(NILTlast$UBELNGH),
                      UBELNI_n = unweighted_n(NILTlast$UBELNI),
                      PRCRICH_n = unweighted_n(NILTlast$PRCRICH),
                      CTHCRICH_n = unweighted_n(NILTlast$CTHCRICH),
                      EMCRICH_n = unweighted_n(NILTlast$EMCRICH),
                      PLINEREM_Rn = unweighted_n(NILTlast$PLINEREM[NILTlast$PLINELIV == "Within a few streets of the nearest Peace Line"]))

yltOld <- data.frame(year = YLTyear - 1,
                     f1_young =  colPct(YLTlast, RLRELAGO, "Better"),
                     f1y_Cath = colPct(YLTlast, RLRELAGO, "Better", religion = "Catholic"),
                     f1y_Prot = colPct(YLTlast, RLRELAGO, "Better", religion = "Protestant"),
                     f1y_NoR = colPct(YLTlast, RLRELAGO, "Better", religion = "No religion"),
                     f2_young =  colPct(YLTlast, RLRELFUT, "Better"),
                     f2y_Cath = colPct(YLTlast, RLRELFUT, "Better", religion = "Catholic"),
                     f2y_Prot = colPct(YLTlast, RLRELFUT, "Better", religion = "Protestant"),
                     f2y_NoR = colPct(YLTlast, RLRELFUT, "Better", religion = "No religion"),
                     f3a_young = colPct(YLTlast, FEELCATH, c("Very favourable", "Quite favourable")),
                     f3b_young = colPct(YLTlast, FEELPROT, c("Very favourable", "Quite favourable")),
                     f3c_young = colPct(YLTlast, FEELMEC, c("Very favourable", "Quite favourable")),
                     f4a_male = colPct(YLTlast, SOCDIFF, c("Very often", "Sometimes"), gender = "Male"),
                     f4a_female = colPct(YLTlast, SOCDIFF, c("Very often", "Sometimes"), gender = "Female"),
                     f4a_overall = colPct(YLTlast, SOCDIFF, c("Very often", "Sometimes")),
                     f4_Cath = colPct(YLTlast, SOCDIFF, c("Very often", "Sometimes"), religion = "Catholic"),
                     f4_Prot = colPct(YLTlast, SOCDIFF, c("Very often", "Sometimes"), religion = "Protestant"),
                     f4_NoR = colPct(YLTlast, SOCDIFF, c("Very often", "Sometimes"), religion = "No religion"),
                     f20_youngNeigh = colPct(YLTlast, BELONGNG, c("Yes, definitely", "Yes, probably")),
                     f20_youngNI = colPct(YLTlast, BELONGNI, c("Yes, definitely", "Yes, probably")),
                     f21a_neighbourhood = colPct(YLTlast, INFLHERE, c("Yes, probably", "Yes, definitely")),
                     f21a_NI = colPct(YLTlast, INFLUNI, c("Yes, probably", "Yes, definitely")),
                     RLRELAGO_YnCath = unweighted_n(YLTlast$RLRELAGO[YLTlast$RELIGCAT == toupper("Catholic")]),
                     RLRELAGO_YnProt = unweighted_n(YLTlast$RLRELAGO[YLTlast$RELIGCAT == toupper("Protestant")]),
                     RLRELAGO_YnNoR = unweighted_n(YLTlast$RLRELAGO[YLTlast$RELIGCAT == toupper("No religion")]),
                     RLRELAGO_Yn = unweighted_n(YLTlast$RLRELAGO),
                     RLRELFUT_YnCath = unweighted_n(YLTlast$RLRELFUT[YLTlast$RELIGCAT == toupper("Catholic")]),
                     RLRELFUT_YnProt = unweighted_n(YLTlast$RLRELFUT[YLTlast$RELIGCAT == toupper("Protestant")]),
                     RLRELFUT_YnNoR = unweighted_n(YLTlast$RLRELFUT[YLTlast$RELIGCAT == toupper("No religion")]),
                     RLRELFUT_Yn = unweighted_n(YLTlast$RLRELFUT),
                     FEELCATH_Yn = unweighted_n(YLTlast$FEELCATH),
                     FEELPROT_Yn = unweighted_n(YLTlast$FEELPROT),
                     FEELMEC_Yn = unweighted_n(YLTlast$FEELMEC),
                     SOCDIFF_Yn = unweighted_n(YLTlast$SOCDIFF),
                     SOCDIFF_YnCath = unweighted_n(YLTlast$SOCDIFF[YLTlast$RELIGCAT == toupper("Catholic")]),
                     SOCDIFF_YnProt = unweighted_n(YLTlast$SOCDIFF[YLTlast$RELIGCAT == toupper("Protestant")]),
                     SOCDIFF_YnMale = unweighted_n(YLTlast$SOCDIFF[YLTlast$RSEX == "Male"]),
                     SOCDIFF_YnFemale = unweighted_n(YLTlast$SOCDIFF[YLTlast$RSEX == "Female"]),
                     BELONGNG_Yn = unweighted_n(YLTlast$BELONGNG),
                     BELONGNI_Yn = unweighted_n(YLTlast$BELONGNI),
                     INFLHERE_Yn = unweighted_n(YLTlast$INFLHERE),
                     INFLUNI_Yn = unweighted_n(YLTlast$INFLUNI))
...
niltNew <- data.frame(year = NILTyear,
                      ...
                      f2a_Cath = colPct(NILT, RLRELFUT, "Better", religion = "Catholic"),
                      f2a_Prot = colPct(NILT, RLRELFUT, "Better", religion = "Protestant"),
                      f2a_NoR = colPct(NILT, RLRELFUT, "Better", religion = "No religion"),
                      ...
                      f8_Prot = colPct(NILT, SCHLCULT2, c("Yes, definitely", "Yes, probably"), religion = "Protestant"),
                      f8_Cath = colPct(NILT, SCHLCULT2, c("Yes, definitely", "Yes, probably"), religion = "Catholic"),
                      f8_NoR = colPct(NILT, SCHLCULT2, c("Yes, definitely", "Yes, probably"), religion = "No religion"),
                      ...
                      RLRELFUT_nCath = unweighted_n(NILT$RLRELFUT[NILT$RELIGCAT == "Catholic"]),
                      RLRELFUT_nProt = unweighted_n(NILT$RLRELFUT[NILT$RELIGCAT == "Protestant"]),
                      RLRELFUT_nNoR = unweighted_n(NILT$RLRELFUT[NILT$RELIGCAT == "No religion"]),
                      ...
                      SCHLCULT2_nCath = unweighted_n(NILT$SCHLCULT2[NILT$RELIGCAT == "Catholic"]),
                      SCHLCULT2_nProt = unweighted_n(NILT$SCHLCULT2[NILT$RELIGCAT == "Protestant"]),
                      SCHLCULT2_nNoR = unweighted_n(NILT$SCHLCULT2[NILT$RELIGCAT == "No religion"]),
                      FEELCATH_n = unweighted_n(NILT$FEELCATH),
                      FEELPROT_n = unweighted_n(NILT$FEELPROT),
                      FEELMEC_n = unweighted_n(NILT$FEELMEG),
...
yltNew <- data.frame(year = YLTyear,
                     ...
                     f2y_Cath = colPct(YLT, RLRELFUT, "Better", religion = "Catholic"),
                     f2y_Prot = colPct(YLT, RLRELFUT, "Better", religion = "Protestant"),
                     f2y_NoR = colPct(YLT, RLRELFUT, "Better", religion = "No religion"),
                     ...
                     RLRELFUT_YnCath = unweighted_n(YLT$RLRELFUT[YLT$RELIGCAT == "Catholic"]),
                     RLRELFUT_YnProt = unweighted_n(YLT$RLRELFUT[YLT$RELIGCAT == "Protestant"]),
                     RLRELFUT_YnNoR = unweighted_n(YLT$RLRELFUT[YLT$RELIGCAT == "No religion"]),
...
dataOld <- full_join(niltOld, yltOld)
...
new_variables <- data.frame(f2a_Cath = NA,
                            f2a_Prot = NA,
                            f2a_NoR = NA,
                            f2y_Cath = NA,
                            f2y_Prot = NA,
...
data <- cbind(data, new_variables)

# Add new data to historic
data <- rbind(data, dataNew, dataOld)
data <- data[-11, ]
...
omniData <- readRDS(paste0("data/omniTo2018.RDS"))

omniDataNew <- c("2022", 56, 44, 73, 42, 12, 39, 18, 24, 25, 21, 20)

omniData <- rbind(omniData, omniDataNew) %>% mutate(across(!year, as.numeric))
...
# New way of calculating homelessTable - old way is commented out below.

homelessTable <- homelessTable %>% select(year, ASB, Disability, Paramilitary, Racial, Sectarian, Orientation, Total)

homelessTable <- homelessTable[-1, ]

niheNew <- homelessTable[-c(1:6), ]
...
#          Other = Total - sum(Paramilitary, ASB, Sectarian, na.rm = TRUE))
# 
...
data[2, which(colnames(data)=="FEELCATH_n")] = unweighted_n(NILT14$FEELCATH)
data[2, which(colnames(data)=="FEELPROT_n")] = unweighted_n(NILT14$FEELPROT)
data[2, which(colnames(data)=="FEELMEC_n")] = unweighted_n(NILT14$FEELMEG)
...
fig5 <- data.frame(activity = c("Projects", "Classes", "Facilities/\nEquipment", "Overall"),
                   young = c(colPct(YLT, DONEWHAT2, "Ticked"),
                             ...
                             colPct(YLT, DONEWHAT5, "Not Ticked")))

fig5last <- data.frame(activity = c("Projects", "Classes", "Facilities/\nEquipment"),
                  young = c(colPct(YLTlast, DONEWHAT2, "Ticked"),
                             colPct(YLTlast, DONEWHAT1, "Ticked"),
                             colPct(YLTlast, DONEWHAT3, "Ticked")))
...
fig8 <- extractFig("f8") %>%
  filter(!is.na(pct)) %>% mutate(Prot = NULL, Cath = NULL, NoR = NULL)

# Extract 3 most recent years
fig9 <- tail(omniData, 4) %>%
  ...
  remove_rownames() %>%
  bind_rows(slice(., 1)) %>% 
  slice(-1)  %>% mutate(across(!activity, as.numeric))

# fig9overall <- fig9[-c(1:9), ]
# 
# fig9a <- fig9[-10, ]
# 
# fig9a <- mutate(fig9a, "2015" = NULL, "2016" = NULL, "2018" = NULL)
# 
# fig9a <- mutate(fig9a, "2015" = 0, "2016" = 0, "2018" = 0)
# 
# fig9 <- rbind (fig9a, fig9overall)
...
fig13 <- data.frame(year = c("2013/14", "2014/15", "2015/16", "2016/17", "2017/18", "2018/19", "2019/20", "2020/21", "2021/22", "2022/23"),
                    pct = c(10, 18, 19, 15, 18, 21, 20, 24, 16, 21)) %>%
  filter(year <= intYear)
...
names(fig14)[names(fig14) == 'Homophobic'] <- 'Sexual orientation'

saveRDS(fig14, psniSave)

# New way of calculating fig15b - old way is commented out below.

fig15b <- homelessTable %>% mutate(across(!year, as.numeric))

# Fig 15b made by combining new and historic
# fig15b <- rbind(nihe, niheNew)
...
fig15a$num = as.numeric(as.character(fig15a$num)) 

fig15a <- fig15a[c(3,1, 5, 4, 2, 6, 7), ]
...
fig19 <- data.frame(resident = c("All", "Residents*"), 
...
# Combined data frame for download buttons
fig20 <- left_join(fig20b, fig20a, by = "belong")
...
# Combined data frame for download buttons
fig21 <- left_join(fig21b, fig21a, by = "influence")
...
historicNew <- data.frame(year = 2022,
...
fig24p <- fig24 %>% mutate(dash1 = case_when(year == 2019 ~ sixteen,
                           year == 2020 ~ lag(sixteen), year == 2021 ~ sixteen,
                           TRUE ~ as.numeric(NA)),
...
<!-- commenting in the below chunk will allow a blue box at the start of the report to be populated with information that needs to be clearly presented to the reader, for e.g. regarding issues with the data or comparability. The text can be populated by editing fig0.R. -->
...
-   In `r NILTyear`, `r projects`% of young people have 'done projects' with pupils from other schools; `r classes`% have 'shared classes'; and `r equipment`% 'shared sports facilities or equipment' where the pupils are from a different religious background.
...
-   `r leisure`% of adults in `r NILTyear` think that leisure centres in their area are 'shared and open' to both Catholics and Protestants; `r park`% think this about parks; `r library`% think this about libraries and `r shopping`% think this about shopping centres.

-   `r workplace`% of adult respondents prefer a mixed religion workplace; `r neighbourhood`% a mixed religion neighbourhood; and `r school`% mixed religion schools.
...
-   `r safeTown`% of adult respondents see town centres as safe and welcoming places for people of all walks of life. `r sigStatement`

-   In `r NILTyear`, `r safeGAA`% of respondents feel 'very' or 'quite' safe going to events held in a GAA club; `r safeOrange`% to events held in an Orange Hall; `r safeProtestant`% to events held in a Protestant Secondary School; and `r safeCatholic`% to events held in a Catholic Secondary School.
...
-   `r cathAgree`% of adult respondents in `r NILTyear` think that the culture and traditions of Catholic communities add to the richness and diversity of Northern Ireland society; `r protAgree`% think this about Protestant communities; and `r minorityAgree`% think this about Minority Ethnic communities.
...
<!-- below commentary is not properly tested - to some extent it operates on the assumption that YP attitudes are always less favourable than adults, which has always been true as of 2022. In saying less/more favourable, it only tests for attitudes to Catholic communities - so far this has never produced an error but it should be checked. -->
...
`r f5_all`% of young people have been involved in shared education with another school. Of those who have been involved in shared education, `r f5_projects`% have 'done projects' with pupils from other schools, while `r f5_classes`% have 'shared classes', and `r f5_equipment`% 'shared sports facilities or equipment'.
...
`r schools`% of schools were involved in shared education with another school in the last academic year. Of those schools who were involved in shared education with another school in the last academic year; `r projects`% had participated in projects; `r resources`% shared resources; `r teachers`% shared teachers; `r classes2`% have shared classes under the entitlement framework;  `r equipment`% shared equipment; `r classes`% have shared classes which are provided other than through the entitlement framework; `r shared`% of schools have developed shared policies; `r extra`% have shared extra-curricular activities; and `r other`% have shared education in 'other' ways.
...
# plot9a <- barChart(fig9a,
#                    x = "activity",
#                    y = "2022")

 # div(class = "row",
 #    div(class = "col-sm-10", plot9a))
 
downloadButtons(fig = fig9,
                indicator = "2.1d",
                headers = c("Activity", "2015 (%)", "2016 (%)", "2018 (%)", "2022 (%)"))
...
lineChart(data = fig11,
          x = "year",
          y1 = "neighbourhood",
          y1Name = "Neighbourhood",
          y2 = "workplace",
          y2Name = "Workplace")

downloadButtons(fig = fig11,
                indicator = "2.2a",
                headers = c("Year", "Neighbourhood (%)", "Workplace (%)"))
...
downloadButtons(fig = fig14,
                indicator = "3.1a",
                headers = c("Year", "Racial", "Sexual orientation", "Sectarian", "Religion", "Disability", "Transphobic"))
...
# below line reshapes data for 2022 specifically

plot15a <- donutChart(data = fig15a,
                      values = "num",
                      sections = "option",
                      colours = c("#426bba", "#c4db0d", "#d0cece", "#002469"),
                      title = "Homeless presentations by\ntype of intimidation 2022/23")
...
div(class = "row",
    div(class = "col-sm-4", style = "padding: 5px", plot15a),
    div(class = "col-sm-8", plot15b))

fig15new <- fig15b[-c(1:6), ]
fig15 <- fig15b %>% mutate(ASB = NA, Disability = NA, Paramilitary = NA, Racial = NA, Sectarian = NA, Orientation = NA)
fig15 <- fig15[-c(7), ]
fig15 <- rbind(fig15, fig15new)

downloadButtons(fig = fig15,
                indicator = "3.1b",
                headers = c("Year", "ASB", "Disability", "Paramilitary", "Racial", "Sectarian", "Orientation", "Total"))
...
`r annoyedR`% of respondents had been annoyed by republican murals, kerb-paintings or flags in the last year, while significantly more respondents had been annoyed by loyalist murals, kerb-paintings or flags (`r annoyedL`%). `r intimidatedR`% of respondents had felt intimidated by republican murals, kerb-paintings or flags in the last year, while significantly more respondents had felt intimidated by loyalist murals, kerb-paintings or flags (`r intimidatedL`%).
...
howWeGotHere(f16para1, f16para2)
...
howWeGotHere(f17para1, f17para2)
...
In `r NILTyear`, `r GAAsafe`% of respondents feel 'very' or 'quite' safe going to events held in a GAA club; `r orangeSafe`% to events held in an Orange Hall; `r protSafe`% to events held in a Protestant secondary school; and `r cathSafe`% to events held in a Catholic secondary school.
...
`r belongNeigh`% of adults feel a sense of belonging towards their neighbourhood, while `r belongNI`% feel a sense of belonging to Northern Ireland. `r adultyoungSentence`
...
Among adults, there is no significant difference in the proportions of male and female respondents who feel they have an influence on decisions taken in either their neighbourhood or Northern Ireland. `r paste(religionneighSentence, religionNISentence)`

```{r figure 21}

chartTitle(21, "% of people who feel they have an influence on decisions made in: their neighbourhood; Northern Ireland")

stackedBarSplit(fig21b, fig21a,
                x = "influence",
                y1 = "prob",
                y1Name = "Yes, probably",
                y2 = "def",
...
howWeGotHere(f22para1, f22para2)
...
howWeGotHere(f23para1, f23para2)
...
plot_ly(fig24p,
  ...
  annotations = list(
    ...
    list(text = "2017 - Assembly\nSuspension", showarrow = FALSE,
         x = 2017, xref = "x", xanchor = "center",
         y = 95, yref = "y", yanchor = "middle"),
     list(text = "2020 - Assembly\nReconvened/\nBrexit", showarrow = FALSE,
         x = 2020, xref = "x", xanchor = "center",
         y = 82, yref = "y", yanchor = "middle"),
     list(text = "2020 -\nCOVID-19", showarrow = FALSE,
         x = 2020, xref = "x", xanchor = "center",
         y = 66, yref = "y", yanchor = "middle"),
      list(text = "2022 - Assembly\nSuspension", showarrow = FALSE,
         x = 2022, xref = "x", xanchor = "center",
         y = 50, yref = "y", yanchor = "middle")),
  shapes = list(
    list(type = line,
...
information <- c("Data to monitor and report on Together: Building a United Community Strategy (2013) key priorities.",
                 ...
                 "Our statistical practice is regulated by the Office for Statistics Regulation (OSR). OSR sets the standards of trustworthiness, quality and value in the Code of Practice for Statistics that all producers of official statistics should adhere to. You are welcome to contact us directly with any comments about how we meet these standards. Alternatively, you can contact OSR by emailing ",
  ...
  if (headings[i] == "Web page") {
    ...
    readerInfo <- paste0(readerInfo,
      ...
      div(class = "row", style = "display: flex;",
          div(class = "row-indent"),
          div(class = "infoItem", style = "width: 20%", headings[i]),
          div(class = "infoItem", style = "width: 80%", information[i], a(href = "https://consultations.nidirect.gov.uk/teo/good-relations-readership-survey-2022", "readership survey"), "or contact", a(href="mailto:teostatisticsresearch@executiveoffice-ni.gov.uk", "teostatisticsresearch@executiveoffice-ni.gov.uk"))),
      
  
          "<br>")
    
  } else if (headings[i] == "Official statistics") {
      ...
      div(class = "row", style = "display: flex;",
          div(class = "row-indent"),
          div(class = "infoItem", style = "width: 20%", headings[i]),
          div(class = "infoItem", style = "width: 80%", information[i], a(href="mailto:regulation@statistics.gov.uk", "regulation@statistics.gov.uk"), "or via the OSR website.")),
