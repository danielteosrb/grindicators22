...
survey was cancelled due to the effects of the COVID-19 pandemic. Data from the 2013 survey cannot be presented here due to changes to question and response wordings.
...
*in previous years, the "Sexual orientation" category was labelled as "homophobic"; this has been changed to remain in line with how the PSNI present these data.
...
\*please note that these data also contain categories pertaining to intimidation on grounds of disability and sexual orientation, however, no clients presented as homeless to NIHE on these grounds in 2022/23, so these categories have been excluded from the graph.
...
`r annoyedR`% of respondents had been annoyed by republican murals, kerb-paintings or flags in the last year; with `r intimidatedR`% feeling intimidated by them. `r f16Sig` respondents had been annoyed by loyalist murals, kerb-paintings or flags in the last year (`r annoyedL`%); with `r intimidatedL`% intimidated by them.
...
Due to COVID-19, some questions in the Northern Ireland Life and Times Survey were reworded in 2020, and these changes were maintained in 2021, and reverted back to their original format in 2022. These changes affected the following Indicators: 2.2a, 3.2a, 3.2b.
