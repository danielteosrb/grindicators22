...
`r f11SigStatement` Protestant respondents are significantly more likely than either Catholic respondents or respondents with no religion to say their neighbourhood is somewhere they can be open about their cultural identity. There were no other significant differences in either of these figures when analysed by religion.
...
plot15a <- donutChart(data = fig15a,
                      ...
                      title = "Homeless presentations\nby type of intimidation")
