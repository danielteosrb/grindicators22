...
`r f5_all`% of young people have been involved in shared education with another school. Of thise who have been involved in shared education, `r f5_projects`% have 'done projects' with pupils from other schools, while `r f5_classes`% have 'shared classes', and `r f5_equipment`% 'shared sports facilities or equipment'.
