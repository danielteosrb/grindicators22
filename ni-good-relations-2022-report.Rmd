...
niltNew <- data.frame(year = NILTyear,
                      ...
                      f8_Prot = colPct(NILT, SCHLCULT2, c("Yes, definitely", "Yes, probably"), religion = "Catholic"),
                      f8_Cath = colPct(NILT, SCHLCULT2, c("Yes, definitely", "Yes, probably"), religion = "Protestant"),
