  ...
  plot_ly(fig21b, # A data fraame
    ...
    layout(
      ...
      annotations = list(
        ...
        list(text = "Adults who think that Protestant\nCommunities add to the richness\nand diversity of Northern Ireland\nsociety",
             showarrow = FALSE,
             x = 0.17, y = 0.75,
             xref = "paper", yref = "paper",
        ...
        list(text = "Adults who think that Catholic\nCommunities add to the richness\nand diversity of Northern Ireland\nsociety",
             showarrow = FALSE,
             x = 0.17, y = 0.45,
             xref = "paper", yref = "paper",
             xanchor = "left", yanchor = "top",
        ...
        list(text = paste0("<b>", round2(minority), "%</b>"),
             ...
             xref = "paper", yref = "paper",
             xanchor = "center", yanchor = "middle"),
        list(text = "Adults who think that Minority\nEthnic Communities add to the\nrichness and diversity of Northern\nIreland society",
             showarrow = FALSE,
             x = 0.17, y = 0.15,
             xref = "paper", yref = "paper",
             xanchor = "left", yanchor = "top",
        ...
        list(text = "<b>Adults who feel they have an influence\non decisions in their neighbourhood</b>",
             ...
             xref = "paper", yref = "paper",
             xanchor = "center", yanchor = "top"),
        list(text = "<b>Adults who feel they have an influence\non Northern Ireland decisions</b>",
             showarrow = FALSE,
             x = 0.75, y = 0.07,
             xref = "paper", yref = "paper",
             xanchor = "center", yanchor = "top"),
