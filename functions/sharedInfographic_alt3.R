sharedInfographic_alt3 <- function() {
    ...
    layout(
      ...
      images = list(
        list(source = dataURI(file = "images/leisure centre.png"),
             x = 0.1, y = 0.97, sizex = 0.16, sizey = 0.16, xanchor = "centre", yanchor = "top"),
        list(source = dataURI(file = "images/park.png"),
             x = 0.1, y = 0.49, sizex = 0.16, sizey = 0.16, xanchor = "centre", yanchor = "middle"),
        list(source = dataURI(file = "images/library.png"),
             x = 0.1, y = 0.02, sizex = 0.16, sizey = 0.16, xanchor = "centre", yanchor = "bottom"),
        list(NA),
        list(NA),
        list(NA)
      ),
