sharedInfographic_alt1 <- function() {
    ...
    layout(
      ...
      images = list(
        ...
        list(source = dataURI(file = "images/workplace.png"),
             x = 0.53, y = 0.96, sizex = 0.16, sizey = 0.16, xanchor = "left", yanchor = "top"),
        list(source = dataURI(file = "images/neighbourhood.png"),
             x = 0.53, y = 0.47, sizex = 0.16, sizey = 0.16, xanchor = "left", yanchor = "middle"),
        list(source = dataURI(file = "images/religion.png"),
             x = 0.53, y = 0, sizex = 0.16, sizey = 0.16, xanchor = "left", yanchor = "bottom")
      ),
